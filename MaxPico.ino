 ...
 */
 ...
 //               MAXPICO https://github.com/McCookieM/MaxPico is forked from MaxDuino solely for Raspberry Pi Pico support. 
 //               Instead of keeping with the MaxDuino multi hardware support, it was decided to separate as the Pico is dual core and
 //               has far more resources than any of the other hardware originally supported in the MaxDuino project. This gives scope
 //               to develop further than MaxDuino
 //
